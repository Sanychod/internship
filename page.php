...
<div class="header-content">
            ...
            if( $link = get_field('header_button') ): 
                ...
                ?>
                <a class="btn btn-order" role="button" href="<?php echo $link['url']; ?>" target="<?php echo $link['target']; ?>"><?php echo $link['title']; ?></a>
            <?php endif; ?>
           ...
           <h1 class="main__title "><?php the_field('main_title'); ?></h1>
            ...
            <div class="about">      
                    ...
                    <div class="about-text">
                        ...
                        $linked = get_field('main_button');
                        if( $linked ): 
                            $linked_url = $linked['#service '];
                            $linked_title = $linked['Learn More'];
                            $linked_target = $linked['target'] ? $linked['target'] : '_self';
                                ?>
                            <a class="btn btn-prime" role="button" href="<?php echo $linked['url']; ?>" target="<?php echo $linked['target']; ?>"><?php echo $linked['title']; ?></a>
                            <?php endif; 
                        ?>
            ...
            <div class="box-item" >
                <div class="box-item__icon">
                    ...
                    <?php 
                        ...
                        if( $phonelink ): ?>
                            <a class="box-item__down" target="<?php echo $phonelink['target']; ?>" href="<?php echo $phonelink['url']; ?>"><?php echo $phonelink['title']; ?></a>
                        <?php endif; ?>
            </div>
